...
/** Sólo dice qué variables están presentes (nunca sus valores). Para diagnosticar. */
...
module.exports = { hayRedis, nochesPagadas, marcarPagada, pagoYaProcesado, marcarPagoProcesado, diagnostico };
