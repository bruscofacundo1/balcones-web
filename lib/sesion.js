...
/**
 * La contraseña del panel. Se acepta ADMIN_TOKEN como nombre viejo para que
 * el panel no se caiga en el momento del cambio; conviene migrar a
 * ADMIN_PASSWORD y borrar la otra.
 */
...
/** Con qué IP contamos los intentos fallados. Detrás de Vercel la IP real
    viene en x-forwarded-for; el primer valor es el cliente. */
function ipDe(req) {
